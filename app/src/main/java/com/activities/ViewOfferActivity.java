...
import com.suraksha.BaseActivity;
...
public class ViewOfferActivity extends BaseActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        ws = new Service1();
        session = new SessionManager(ViewOfferActivity.this);
        lv = (ListView) findViewById(R.id.list_viewOffer);

        try {
            Intent in = ViewOfferActivity.this.getIntent();
        ...
        ViewOfferActivity.viewOfferList ds = new ViewOfferActivity.viewOfferList();
        ds.execute();
...
//                perchasedialoag(offerid.getText().toString(), offername.getText().toString(), String.valueOf(2),txtdiscription.getText().toString());
                if (Integer.parseInt(coinbal) > Integer.parseInt(oferprice.getText().toString())) {
                    ...
                    Toast.makeText(ViewOfferActivity.this, "You don't have enough balance to purchase", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
    ...
    public void perchasedialoag(final String offerId, final String offerName, final String price, String discription) {
        ...
        btnpuchaseoffer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                dialog.dismiss();
                ViewOfferActivity.purchaseOffer des = new ViewOfferActivity.purchaseOffer(offerId, price);
                des.execute();
            }
    ...
    private class purchaseOffer extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progress = new ProgressDialog(ViewOfferActivity.this);
        ...
        protected void onPostExecute(Void result) {
            if (value.equals("true")) {
                ViewOfferActivity.updateCoin ds = new ViewOfferActivity.updateCoin(PRICE);
                ds.execute();
            } else {
                progress.dismiss();
                Toast.makeText(ViewOfferActivity.this, "Offer Not purchase", Toast.LENGTH_LONG).show();
    ...
    private class updateCoin extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void result) {
            ...
            if (value.equals("true")) {
                Toast.makeText(ViewOfferActivity.this, "Offer Purchase Successfully", Toast.LENGTH_LONG).show();
        ...
        protected void onPostExecute(Void result) {
            ...
            if (ds != null) {
                ...
                if (ds.length() > 0) {
                    ...
                    SimpleAdapter adapter = new SimpleAdapter(ViewOfferActivity.this, List1, R.layout.view_offer_list_item, new String[]
                    ...
                    Toast.makeText(ViewOfferActivity.this, "No Offer", Toast.LENGTH_LONG).show();
                }
            ...
            if (!TextUtils.isEmpty(offer) && !offer.equals("profile")) {
                ViewOfferActivity.getCoins dsa = new ViewOfferActivity.getCoins();
                dsa.execute();
            } else {
                progress.dismiss();
            }
